...
class CausalDiffusionInferencePipeline(torch.nn.Module):
    def __init__(
        ...
        wan_model_root = getattr(args, "wan_model_root", None)
        self.generator = WanDiffusionWrapper(
            **getattr(args, "model_kwargs", {}), is_causal=True, model_root=wan_model_root) if generator is None else generator
        self.text_encoder = WanTextEncoder(model_root=wan_model_root, model_name=model_name) if text_encoder is None else text_encoder
